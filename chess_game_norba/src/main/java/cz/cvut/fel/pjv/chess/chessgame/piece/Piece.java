...
public abstract class Piece {
    ...
    /**
     * @param color - piece color - 0 for black and 1 for white
     * @param initSq - square where is piece being placed
     * @param img_file - string representation of resource image
     */
